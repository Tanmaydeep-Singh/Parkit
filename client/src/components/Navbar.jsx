...
function Navbar() {
  ...
  return (
    ...
    <div  onClick={handleNav}  className={ nav ? 'absolute left-0 text-black top-0 w-full bg-gray-100/90 px-4 py-7 flex flex-col' :  'absolute left-[-100%] top-0 w-full bg-gray-100/90 px-4 py-7 flex flex-col'}>
    <ul className=''>
    <h1>Logo</h1>
